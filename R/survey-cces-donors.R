...
# who they gave to
# CC416a_1	Candidate for President
# CC416a_2	Candidate for US Senate in my state 
# CC416a_3	Candidate for US Senate in another state
# CC416a_4	Candidate for US House in my district
...
#C2020 <- read_dta("~/Dropbox/B_polls/CES2020/CCES20_Common_OUTPUT.dta")
...
library(pollster)
pollster::crosstab(df = CC %>% filter(midterm_year==1),
         x = year,
         y = donated,
         weight = w,
         unwt_n = TRUE)
