...
cong_complete$house %>% filter(contribution_blurb != "") %>% tally()
cong_complete$house %>% filter(contribution_blurb != "" | text != "") %>% tally()

cong_complete$senate %>% tally()
cong_complete$senate %>% filter(text != "") %>% tally()
cong_complete$senate %>% filter(contribution_blurb != "" | text != "") %>% tally()
