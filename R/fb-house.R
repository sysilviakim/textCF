...
hr.query.43.1 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.43.2 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.43.3 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.43.4 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.43.5 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.43.6 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.43.7 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.43.8 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.43.10 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.48.notaoc <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.48.aoc <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.48.aoc.2 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
  search_page_ids = hr.id.48.aoc,
...
hr.query.48.aoc.3 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
  search_page_ids = hr.id.48.aoc,
...
hr.query.48.aoc.4 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
  search_page_ids = hr.id.48.aoc,
...
# Round five.
hr.query.48.aoc.5 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
  search_page_ids = hr.id.48.aoc,
...
# Round six
hr.query.48.aoc.6 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
  search_page_ids = hr.id.48.aoc,
...
# Round seven
hr.query.48.aoc.7 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
  search_page_ids = hr.id.48.aoc,
...
hr.tibble.aoc <- rbind(
  hr.tibble.48.aoc, hr.tibble.48.aoc.2,
...
hr.query.55b <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
  search_page_ids = hr.id.55,
...
hr.query.64.less <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
hr.query.64.less.2 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
  search_page_ids = hr.id.64.less,
...
hr.query.68.2 <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
  search_page_ids = hr.id.68,
...
herrell.query <- adlib_build_query(
  ad_reached_countries = "US",
  ad_active_status = "ALL",
...
id_vector <- as.vector(c(
  herrell, budd, gonzales, blanco, collins, betts,
  beyer
))
