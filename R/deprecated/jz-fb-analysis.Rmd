...
# Produce with: "10_text_prep_FB.R"
...
- We remove duplicates
  - The approach here is defensible but maybe worth checking this again (fields other than text are considered for identifying duplicates)
...
- We tokenize the text, pre-processing the inputs as follows:
  - Removing English and Spanish stopwords
  - lower-casing the words
  - Removing most punctuation.
- We currently do not apply a stemmer (the trolling dictionary includes all inflection of stems, so this is currently preferred).
